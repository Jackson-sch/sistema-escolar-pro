    ...
    <div className="space-y-8 pb-20">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-zinc-500 uppercase font-medium tracking-widest mt-0.5">
            Detalles de la Sede
          </p>
        </div>
      </div>
          ...
          <div className="rounded-3xl bg-zinc-900 border border-white/5 overflow-hidden">
            <div className="p-8 border-b border-white/5 bg-linear-to-br from-indigo-500/5 to-transparent">
              <div className="flex items-start justify-between">
                ...
                <span
                  className={`px-4 py-1.5 rounded-full text-xxs font-medium uppercase tracking-widest ${inst._count.users > 0 ? "bg-emerald-500/10 text-emerald-500 border border-emerald-500/20" : "bg-orange-500/10 text-orange-500 border border-orange-500/20"}`}
                >
            ...
            <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div>
                      <p className="text-xxs text-zinc-500 uppercase font-medium tracking-wider">
                        Dirección
                      </p>
          ...
          <div className="rounded-3xl bg-zinc-900 border border-white/5 p-8">
            ...
            <div className="overflow-x-auto">
              <Table className="w-full text-left">
                <TableHeader>
                  <TableRow className="text-xxs text-zinc-500 uppercase font-medium tracking-[0.2em] border-b border-white/5">
                ...
                <TableBody className="divide-y divide-white/5 text-sm">
                  {inst.users.map((user: any) => (
                    <TableRow key={user.id} className="group">
                      ...
                      <TableCell className="py-4 uppercase text-xxs font-medium text-zinc-500 tracking-wider">
                        {user.role}
                      </TableCell>
          ...
          <div className="rounded-3xl bg-zinc-900 border border-white/5 p-6 shadow-lg shadow-black/40">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xl font-medium">{inst._count.users}</span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-xl font-medium">{inst._count.sedes}</span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
