...
export function AddEvaluacionButton({ tipos, periodos, cursos }: AddEvaluacionButtonProps) {
    ...
    <>
      <Tooltip>
        <TooltipTrigger asChild>
          <Button size="sm" onClick={() => setOpen(true)} className="shadow-lg transition-all active:scale-95">
