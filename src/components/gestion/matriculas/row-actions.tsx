...
import { EnrollmentViewSheet } from "./enrollment-view-sheet"
import { EnrollmentPaymentsSheet } from "./enrollment-payments-sheet"
...
export function EnrollmentRowActions({ row, institucion }: EnrollmentRowActionsProps) {
