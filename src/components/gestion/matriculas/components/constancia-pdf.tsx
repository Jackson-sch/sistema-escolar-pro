...
import {
  DocumentWrapper,
  pdfStyles,
} from "@/components/gestion/documentos/document-wrapper";
    ...
    >
      <View style={{ marginTop: 20 }}>
        ...
        <Text style={{ textAlign: "justify" }}>
          ...
          <Text style={pdfStyles.bold}>MATRICULADO</Text> para cursar estudios
          correspondientes al{" "}
          <Text style={pdfStyles.bold}>
            Año Académico {enrollment.anioAcademico}
          </Text>
          , conforme a los registros oficiales de esta casa de estudios. El
      ...
      >
        ...
        >
          <Text style={{ fontSize: 9, fontWeight: "bold", color: "#475569" }}>
            DETALLES DE UBICACIÓN ACADÉMICA
          </Text>
        </View>
        <View
          style={{
        ...
        >
          <Text style={{ width: "30%", color: "#64748b", fontWeight: "bold" }}>
            NIVEL EDUCATIVO:
          </Text>
        ...
        <View style={{ padding: 10, flexDirection: "row" }}>
          ...
          <Text style={{ width: "70%", fontWeight: "bold" }}>
            "{enrollment.nivelAcademico.seccion}"
          </Text>
        </View>
      </View>
      ...
      <View style={{ marginTop: 20, textAlign: "right" }}>
        <Text>
          {institucion.provincia || "Ciudad"}, {today}
        </Text>
      </View>
