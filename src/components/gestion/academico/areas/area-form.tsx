    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <Card>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input {...field} placeholder="Ejem: Ciencia y Tecnología" className="pl-10 rounded-full" />
                      </div>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input {...field} placeholder="CYT-CORE" className="pl-10 rounded-full" />
                      </div>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
          ...
          <CardFooter>
            <Button disabled={isPending} type="submit" className="w-full font-medium rounded-full">
