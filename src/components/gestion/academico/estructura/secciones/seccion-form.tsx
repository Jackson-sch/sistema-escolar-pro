                ...
                <div className="flex flex-wrap gap-2 items-center">
                  {colors.map((color) => (
                    <button
                      ...
                      className={cn(
                        "size-8 rounded-full border-2 transition-all duration-200 flex items-center justify-center",
                        field.value === color
                  ...
                  <div className="relative">
                    <button
                      ...
                      className={cn(
                        "size-8 rounded-full border-2 border-dashed transition-all duration-200 flex items-center justify-center",
