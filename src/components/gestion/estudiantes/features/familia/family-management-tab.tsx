...
import { FamilyMemberForm } from "@/components/gestion/estudiantes/features/familia/family-member-form";
import {
            ...
            >
              <div className="flex justify-between items-start">
                <div className="flex gap-4">
                  <div className="size-12 rounded-xl bg-cyan-500/10 flex items-center justify-center text-cyan-500 border border-cyan-500/20">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <p className="font-semibold capitalize tracking-tight">
                        ...
                        {rel.padreTutor.apellidoMaterno}
                      </p>
                      {rel.contactoPrimario && (
                        <Badge className="bg-emerald-500/15 text-emerald-500 border-emerald-500/20 text-[9px] font-black capitalize tracking-widest h-5 px-2">
                          Principal
                        </Badge>
                      )}
                    </div>
                    <p className="text-xs text-muted-foreground capitalize mt-0.5">
                      {rel.parentesco.toLowerCase()}
                    </p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start gap-2">
                  <IconPhone className="size-3.5 text-cyan-500/60 mt-0.5" />
