      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="relative group overflow-hidden bg-background/40 backdrop-blur-xl p-4 rounded-2xl border border-white/5 shadow-2xl transition-all duration-300 hover:border-violet-500/30">
          ...
          <p className="text-sm font-bold tracking-tight">
            {admision.fechaEntrevista ? formatDate(admision.fechaEntrevista, "PPP") : "Pendiente"}
          </p>
        </div>
        ...
        <div className={cn(
          ...
          <p className="text-sm font-black tracking-tighter">{admision.prospecto.estado}</p>
        </div>
      </div>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  <FormLabel className="text-[11px] font-bold tracking-widest text-muted-foreground/70 mb-2 ml-1">Fecha de Entrevista</FormLabel>
                  <Popover>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-[11px] font-bold tracking-widest text-muted-foreground/70 mb-2 ml-1">Resultado del Examen</FormLabel>
                <FormControl>
                  <Input
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-[11px] font-bold tracking-widest text-muted-foreground/70 mb-2 ml-1">Observaciones y Notas</FormLabel>
                <FormControl>
                  <Textarea
