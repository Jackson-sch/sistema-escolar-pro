  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <Button
        ...
        disabled={isScanning}
        className="h-10 px-4 border-violet-500/30 bg-violet-500/5 hover:bg-violet-500/10 text-violet-600 hover:text-violet-700 font-bold gap-2 rounded-xl transition-all active:scale-95"
      >
        {isScanning ? (
