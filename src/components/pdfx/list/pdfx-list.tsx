...
function renderNumberedItem(
  ...
  return (
    <View key={`num-${item.text}`} style={buildRowStyles(index, total, gap, styles, 'center')}>
...
function renderChecklistItem(
  ...
  return (
    <View key={`check-${item.text}`} style={buildRowStyles(index, total, gap, styles, 'center')}>
...
function renderIconItem(
  ...
  return (
    <View key={`icon-${item.text}`} style={buildRowStyles(index, total, gap, styles, 'center')}>
...
function renderMultiLevelItem(
  ...
  return (
    <View key={`multi-${level}-${item.text}`}>
      <View style={buildRowStyles(index, total, gap, styles)}>
        {dotMarker(level, styles)}
        <View style={styles.itemTextWrap}>
          <PDFText
...
function renderDescriptiveItem(
  ...
  return (
    <View key={`desc-${item.text}`} style={buildRowStyles(index, total, gap, styles)}>
