          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            {onViewAll && (
              <Button
                ...
                onClick={onViewAll}
                size="lg"
                className="rounded-full px-8 h-11 border-border/60 bg-background/80 hover:bg-muted/80 transition-[background-color,transform] active:scale-95 text-muted-foreground"
              >
                Ver Todos
              </Button>
            )}
