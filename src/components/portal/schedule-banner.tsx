...
export function ScheduleBanner() {
  return (
    <div className="relative overflow-hidden rounded-3xl border border-amber-500/20 bg-card/50 p-8 @container/banner">
      <div className="relative z-10 flex flex-col gap-3 md:max-w-[70%]">
        <Badge className="w-fit border-none bg-amber-500/10 text-amber-500 hover:bg-amber-500/20 transition-colors">
          Horarios Académicos
        </Badge>
      ...
      <div className="absolute -right-24 -top-24 size-80 rounded-full bg-amber-600/10 blur-[120px]" />
      <div className="absolute -bottom-24 -left-24 size-64 rounded-full bg-orange-500/10 blur-[100px]" />
      <IconClock className="absolute -bottom-10 -right-10 size-64 -rotate-12 text-amber-500/5 select-none" />
