...
export function NotasBanner() {
  return (
    <div className="relative overflow-hidden rounded-3xl border border-violet-500/20 bg-card/50 p-8 @container/banner">
      <div className="relative z-10 flex flex-col gap-3 md:max-w-[70%]">
        <Badge className="w-fit border-none bg-violet-500/10 text-violet-500 hover:bg-violet-500/20 transition-colors">
      ...
      <div className="absolute -right-24 -top-24 size-80 rounded-full bg-violet-600/10 blur-[120px]" />
      <div className="absolute -bottom-24 -left-24 size-64 rounded-full bg-purple-500/10 blur-[100px]" />
      <IconCertificate className="absolute -bottom-10 -right-10 size-64 -rotate-12 text-violet-500/5 select-none" />
