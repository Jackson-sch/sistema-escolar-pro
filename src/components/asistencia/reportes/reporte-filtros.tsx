...
export function ReporteFiltros({
  ...
  return (
    <div className="space-y-6">
      <TooltipProvider>
        <div className="flex flex-wrap items-center gap-2 p-1.5 bg-muted/40 border border-border/40 rounded-full w-fit">
          {[
            ...
            <Tooltip key={type.id} delayDuration={0}>
              <TooltipTrigger asChild>
                <Button
                  ...
                  className={cn(
                    "flex items-center gap-2 px-3 sm:px-4 py-2 text-xs sm:text-sm transition-all rounded-full outline-none",
                    reportType === type.id
              ...
              <TooltipContent
                side="bottom"
                className="sm:hidden font-semibold text-[11px] py-1.5 px-3 bg-primary text-primary-foreground border-none"
              >
                {type.label}
              </TooltipContent>
            </Tooltip>
      ...
      <div className="bg-card border rounded-2xl p-4 md:p-5 backdrop-blur-sm shadow-sm">
        <div className="grid grid-cols-2 sm:grid-cols-8 lg:grid-cols-12 gap-4 lg:gap-6 items-end">
          <div className="space-y-2 sm:col-span-4 lg:col-span-2">
            ...
            >
              <SelectTrigger className="bg-background/20 border-border/40 transition-all hover:bg-background/40 w-full rounded-full">
          ...
          {reportType === "individual" && (
            <div className="space-y-2 sm:col-span-4 lg:col-span-6">
              <label className="text-[11px] font-semibold text-muted-foreground ml-1">
                Estudiante
              </label>
              <Select
              ...
              >
                <SelectTrigger className="bg-background/20 border-border/40 transition-all hover:bg-background/40 w-full rounded-full capitalize">
                  <SelectValue
                    placeholder={
                      !seccionId
          ...
          <Button
            ...
            className="sm:col-span-4 lg:col-span-2 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-xs shadow-lg shadow-primary/20 transition-all active:scale-95 rounded-full"
          >
            {isPending ? (
