...
export function PagoDialog({
  ...
  // Estado del diálogo agrupado en un reducer: muchas piezas cambian juntas
  // (reset, inicialización y resultado del pago) y así se mantienen consistentes.
...
/* Panel izquierdo: estudiante, deuda y resumen financiero */
function PagoSummaryPanel({
  cronograma,
  deudaCalculada,
  montoCobrado,
  saldoRestante,
      ...
      >
        ...
        >
          <div className="relative group">
            ...
            <Input
              ...
              onChange={(e) =>
                onPatch({ montoPago: e.target.value })
              }
        ...
        >
          <Input
            ...
            onChange={(e) =>
              onPatch({ numeroBoleta: e.target.value })
            }
        ...
        >
          <Textarea
            ...
            onChange={(e) =>
              onPatch({ observaciones: e.target.value })
            }
          />
        </FieldWrapper>
        ...
        <button
          ...
          className={cn(
            "relative w-full h-12 rounded-xl font-bold text-sm tracking-wide overflow-hidden transition-[box-shadow,opacity,transform] duration-200 outline-none focus-visible:ring-2 focus-visible:ring-blue-500/60 active:scale-[0.99] disabled:opacity-40 disabled:cursor-not-allowed",
      ...
      {METODOS.map((m) => {
        ...
        return (
          <button
            ...
            className={cn(
              "relative flex flex-col items-center justify-center gap-1.5 py-3 px-2 rounded-xl border transition-shadow duration-200 outline-none focus-visible:ring-1 focus-visible:ring-blue-500/60 overflow-hidden",
              isActive
