...
export function VerificacionVoucher({ archivoUrl }: VerificacionVoucherProps) {
  ...
  return (
    <div className="sticky top-0">
      ...
      <div className="group relative aspect-3/4 bg-zinc-100 dark:bg-zinc-900 rounded-2xl overflow-hidden border-2 border-zinc-200 dark:border-zinc-800 shadow-lg transition duration-500">
        ...
        {/* Zoom Info Label */}
        {zoomScale > 1 && (
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-30 px-4 py-1.5 bg-zinc-900/90 text-white text-[10px] font-bold rounded-full border border-white/10 shadow-lg pointer-events-none uppercase">
        ...
        {zoomScale === 1 && (
          <div className="absolute inset-0 bg-black/5 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center pointer-events-none z-20">
            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-3xl px-5 py-2.5 rounded-full border shadow-lg shadow-primary/5">
