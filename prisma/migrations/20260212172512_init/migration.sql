...
CREATE TABLE "User" (
    ...
    "centroSaludPreferido" TEXT,
    "peso" DOUBLE PRECISION,
    "talla" DOUBLE PRECISION,
    "parentescoContactoEmergencia" TEXT,
    "nombreContactoEmergencia2" TEXT,
    "telefonoContactoEmergencia2" TEXT,
    "parentescoContactoEmergencia2" TEXT,
    "paisNacimiento" TEXT,
    "lugarNacimiento" TEXT,
    "lenguaMaterna" TEXT,
    "religion" TEXT,
    "numeroHermanos" INTEGER,
...
CREATE TABLE "Matricula" (
    ...
    "procedencia" TEXT,
    "observaciones" TEXT,
    "tipoBeca" TEXT DEFAULT 'ninguna',
    "descuentoBeca" DOUBLE PRECISION DEFAULT 0,
...
CREATE TABLE "FichaPsicopedagogica" (
    ...
    "visibleParaPadres" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "ConceptoPago" (
    ...
    "activo" BOOLEAN NOT NULL DEFAULT true,
    "institucionId" TEXT NOT NULL,
    "moraDiaria" DOUBLE PRECISION NOT NULL DEFAULT 0,
